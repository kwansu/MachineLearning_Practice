...
class World_Othello:
    ...
    def put(self, row, col, isBlack)->bool:
        cell : Cell = self.cells[col,row]
        ...
        for dir in range(0,8):
            if self.changeColor(cell.Around[dir],dir,isBlack):
                isChanged = True
        
        return isChanged

    
    def changeColor(self, cell:Cell, dir, isChangeToBlack)->bool:
        ...
        if self.changeColor(cell.Around[dir], dir, isChangeToBlack):
